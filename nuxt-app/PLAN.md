...
- [x] **Этап 4: Клиент — Основная таблица**
...
- [x] **Этап 5: Клиент — Детали запроса**
...
- [x] **Этап 6: Фильтрация логов**
  - Создание реактивного состояния для фильтров (search, methods, statuses).
  - Реализация UI-панели фильтров над таблицей.
  - Добавление `computed` свойства `filteredLogs` для фильтрации данных на клиенте.
  - *Что проверить:* Ввод текста в поиск или выбор метода скрывает неподходящие строки в таблице.
